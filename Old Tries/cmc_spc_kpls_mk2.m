...
for sub = 1:52
    ...
    %% SPC training data for SVM and KPLS-mRMR for best features
    %Uses most important EEG channel

    spc_value_right = corr_right_store1(:, right_eeg) - corr_left_store(:, left_eeg);
    %spc_value_left = corr_left_store2(:, right_eeg) - corr_right_store2(:, left_eeg);
    %data = [spc_value_right; spc_value_left];
    ...
    %model = fitcsvm(data, labels,  'Verbose', 1, 'ScoreTransform', 'logit');
