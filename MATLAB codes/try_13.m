...
for trial = indices
   %Positive Class
    ...
    FDP_right = filter(f1, f2, eeg.imagery_right(FDP, trial - 256: trial + 256));
    %Bandpass filter
    ...
    FDP_left = filter(f1, f2, eeg.imagery_left(FDP, trial - 256: trial + 256));
    %Bandpass filter
    ...
    %Features
    C3_FDP_right = our_algo_9(C3_right, FDP_right, Fs);
    Cz_FDP_right = our_algo_9(Cz_right, FDP_right, Fs);
    C4_FDP_right = our_algo_9(C4_right, FDP_right, Fs);
    
    C3_FDP_left  = our_algo_9(C3_left, FDP_left, Fs);
    Cz_FDP_left  = our_algo_9(Cz_left, FDP_left, Fs);
    C4_FDP_left  = our_algo_9(C4_left, FDP_left, Fs);
