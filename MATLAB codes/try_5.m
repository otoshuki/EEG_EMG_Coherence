...
for trial = indices
    ...
    %Rel Scores
    %C3_FDP_left  = our_algo_3(C3_left, FDP_left, Fs);
    C4_FDP_left  = our_algo_3(C4_left, FDP_left, Fs);
    %C3_FDP_right = our_algo_3(C3_right, FDP_right, Fs);
    C4_FDP_right = our_algo_3(C4_right, FDP_right, Fs);
...
data = [abs(C4_FDP_left_store); abs(C4_FDP_right_store)];
